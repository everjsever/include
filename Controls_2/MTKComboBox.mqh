...
bool CComboBox::CreateEdit(void)
  {
//--- create
   if(!m_edit.Create(m_chart_id,m_name+"Edit",m_subwin,0,0,Width()-(CONTROLS_BUTTON_SIZE25+CONTROLS_COMBO_BUTTON_X_OFF),Height()))
      return(false);
   if(!m_edit.Text(""))
      return(false);
...
//--- right align button (try to make equal offsets from top and bottom)
   int x1=Width()-(CONTROLS_BUTTON_SIZE25+CONTROLS_COMBO_BUTTON_X_OFF);
   int y1=(Height()-CONTROLS_BUTTON_SIZE25)/2;
   int x2=x1+CONTROLS_BUTTON_SIZE25;
   int y2=y1+CONTROLS_BUTTON_SIZE25;
//--- create
